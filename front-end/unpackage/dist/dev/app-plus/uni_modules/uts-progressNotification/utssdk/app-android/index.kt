...
open class FinishNotificationProgressOptions (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("FinishNotificationProgressOptions", "uni_modules/uts-progressNotification/utssdk/interface.uts", 23, 13)
    }
}
...
open class TransparentActivity : Activity, IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("TransparentActivity", "uni_modules/uts-progressNotification/utssdk/app-android/TransparentActivity.uts", 11, 14);
    }
    constructor() : super() {}
...
fun globalNotificationProgressCallBackByJs(): Unit {
