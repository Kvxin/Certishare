...
const api_answer = require("../../api/answer.js");
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const questionNum = common_vendor.ref(0);
    const init = () => {
    ...
    const submit = () => {
      ...
      api_answer.postAnswer(answer).then((res) => {
    ...
    common_vendor.onLoad((options) => {
      ...
      api_answer.getQuestion(selectQuestionList, userId).then((res) => {
    ...
    return (_ctx, _cache) => {
      return {
        a: common_vendor.f(10, (index, k0, i0) => {
          return {
            a: index,
            b: index < questionNum.value ? 1 : "",
            c: common_vendor.o(($event) => jumpNum(index), index)
          };
        }),
        b: common_vendor.f(questionList.value, (item, itemIndex, i0) => {
          return {
            a: common_vendor.t(item.title),
            b: common_vendor.f(item.optionsData, (option, index, i1) => {
              return {
                a: common_vendor.t(index),
                b: common_vendor.t(option),
                c: common_vendor.o(($event) => selectAnswer(option, index, itemIndex)),
                d: isSelected(itemIndex, index) ? 1 : ""
              };
            }),
            c: itemIndex
          };
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-debf16ab"], ["__file", "G:/网页/重构/certishare_v3/certishare_v3/pages/knowledge/knowledge.vue"]]);
