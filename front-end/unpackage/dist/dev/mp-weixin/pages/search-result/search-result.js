...
if (!Array) {
  ...
  (_easycom_u_search2 + _easycom_uni_nav_bar2)();
}
const _easycom_u_search = () => "../../uni_modules/uview-plus/components/u-search/u-search.js";
const _easycom_uni_nav_bar = () => "../../uni_modules/uni-nav-bar/components/uni-nav-bar/uni-nav-bar.js";
if (!Math) {
  (_easycom_u_search + _easycom_uni_nav_bar + common_vendor.unref(SearchResultCardWarpVue))();
}
const SearchResultCardWarpVue = () => "../../components/SearchResultCardWarp/SearchResultCardWarp.js";
const _sfc_main = {
  __name: "search-result",
  setup(__props) {
    const searchKey = common_vendor.ref("");
    const cardsDatas = common_vendor.ref([]);
    const getCardNum = common_vendor.computed(() => {
      return `获取到了${cardsDatas.value.length}条数据`;
    });
    const getSearchResult = async (searchText) => {
      api_search.getSarch(searchText).then((res) => {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        f: common_vendor.t(getCardNum.value),
        g: common_vendor.p({
          cardsDatas: cardsDatas.value
        })
      };
    };
  }
};
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-8bf7ac7a"], ["__file", "G:/网页/重构/certishare_v3/certishare_v3/pages/search-result/search-result.vue"]]);
