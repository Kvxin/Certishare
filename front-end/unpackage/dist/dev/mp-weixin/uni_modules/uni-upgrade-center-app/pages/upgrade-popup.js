...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    c: common_vendor.t(_ctx.version),
    ...
    w: $data.installing,
    x: $data.installing,
    y: common_vendor.o((...args) => $options.installPackage && $options.installPackage(...args))
  } : $data.installed && $options.isWGT ? {
    A: common_vendor.o((...args) => $options.restart && $options.restart(...args))
  } : {}, {
    p: $data.downloadSuccess && !$data.installed,
    v: $data.installed && !$options.isWGT,
    z: $data.installed && $options.isWGT
  }), {
    B: !$data.is_mandatory
  }, !$data.is_mandatory ? {
    C: common_vendor.o((...args) => $options.closeUpdate && $options.closeUpdate(...args))
  } : {});
}
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "G:/网页/重构/certishare_v3/certishare_v3/uni_modules/uni-upgrade-center-app/pages/upgrade-popup.vue"]]);
