  ...
  computed: {
    themeBgColor() {
      if (this.gradientColors.length === 2) {
        return `linear-gradient(90deg, ${this.gradientColors[0]}, ${this.gradientColors[1]})`;
      } else if (this.dark) {
        return this.backgroundColor ? this.backgroundColor : this.dark ? "#333" : "#FFF";
      }
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-26544265"], ["__file", "G:/网页/重构/certishare_v3/certishare_v3/uni_modules/uni-nav-bar/components/uni-nav-bar/uni-nav-bar.vue"]]);
