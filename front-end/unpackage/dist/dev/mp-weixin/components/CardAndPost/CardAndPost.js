...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const userStore = stores_userStore.useUserStore().getUserData;
    ...
    common_vendor.onMounted(async () => {
      const users = common_vendor.index.getStorageSync("userData");
      if (users) {
        api_user.getUserCardData(userStore.id).then((res) => {
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-016cc4a0"], ["__file", "G:/网页/重构/certishare_v3/certishare_v3/components/CardAndPost/CardAndPost.vue"]]);
