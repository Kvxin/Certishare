...
const api_Carousel = require("../../api/Carousel.js");
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    common_vendor.onMounted(() => {
      api_Carousel.getCarousel().then((res) => {
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "G:/网页/重构/certishare_v3/certishare_v3/components/CarouselWarp/CarouselWarp.vue"]]);
