...
const components_mpHtml_emoji_index = require("./emoji/index.js");
const components_mpHtml_highlight_index = require("./highlight/index.js");
const components_mpHtml_latex_index = require("./latex/index.js");
const components_mpHtml_style_index = require("./style/index.js");
const components_mpHtml_editable_index = require("./editable/index.js");
require("./markdown/marked.min.js");
require("./highlight/prism.min.js");
require("./latex/katex.min.js");
require("./style/parser.js");
require("./editable/config.js");
const node = () => "./node/node.js";
const plugins = [components_mpHtml_markdown_index.Markdown, components_mpHtml_emoji_index.Emoji, components_mpHtml_highlight_index.Highlight, components_mpHtml_latex_index.Latex, components_mpHtml_style_index.Style, components_mpHtml_editable_index.Editable];
const _sfc_main = {
  name: "mp-html",
  data() {
    return {
  ...
  methods: {
    ...
    navigateTo(id, offset) {
      ...
      return new Promise((resolve, reject) => {
        ...
        let deep = " ";
        deep = ">>>";
        const selector = common_vendor.index.createSelectorQuery().in(this._in ? this._in.page : this).select(
          (this._in ? this._in.selector : "._root") + (id ? `${deep}#${id}` : "")
        ).boundingClientRect();
        if (this._in) {
    ...
    getRect() {
      return new Promise((resolve, reject) => {
        common_vendor.index.createSelectorQuery().in(this).select("#_root").boundingClientRect().exec(
          (res) => res[0] ? resolve(res[0]) : reject(Error("Root label not found"))
        );
      });
    },
    /**
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "G:/网页/重构/certishare_v3/certishare_v3/components/mp-html/mp-html.vue"]]);
